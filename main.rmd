...
En la regresión lineal, los coeficientes b0​ y b1​ se refieren a la ordenada al origen y la pendiente, respectivamente, en la ecuación de la línea de regresión.
    Coeficiente de Intercepto (b0​):
        Definición: b0​ representa la ordenada al origen, es decir, el valor de la variable dependiente cuando la variable independiente es cero.
        Fórmula: En una regresión lineal simple, la ecuación de la línea es y=b0+b1xy=b0​+b1​x, por lo que b0​ es el valor de yy cuando xx es igual a cero.

    Coeficiente de Pendiente (b1​):
        Definición: b1​ representa la pendiente de la línea de regresión, es decir, la tasa de cambio en la variable dependiente por unidad de cambio en la variable independiente.
        Fórmula: La ecuación de la línea de regresión es y=b0+b1xy=b0​+b1​x, y b1​ es el coeficiente asociado con la variable independiente xx. Indica cuánto cambia yy por cada unidad de cambio en xx.
...
En este caso se realizó el test de hipótesis para el coeficiente de regresión, el cual se utiliza para evaluar la significancia de cada coeficiente por separado. Se compara el coeficiente estimado con su error estándar y calcula el p-value para determinar si el coeficiente en cuestión es estadísticamente significativo.
...
Para realizar el test de normalidad se utilizó la función “shapiro.test(model$residuals)” y se muestra en la consola.
...
Para realizar el test de homocedasticidad se utilizó la función “ncvTest(model)” y se muestra en la consola.
